      ...
      <form onSubmit={this.handleSubmit}>
        <div className="form-group row">
          ...
          <div className='col-sm-10 input'>
            <input type="text" name="name" id="name" className = 'w-100'value={this.state.name} onChange = {this.handleChange}/>
          </div>
        </div>
        <div className='form-group row'>
          <label htmlFor="course" className='col-sm-2 col-form-label'><i className='far fa-window-maximize'></i></label>
          <div className='col-sm-10 input'>
            <input type="text" name="course" id="course" className="w-100" value={this.state.course} onChange = {this.handleChange}/>
          </div>
        </div>
        <div className='form-group row'>
          <label htmlFor="grade" className='col-sm-2 col-form-label'><i className='fas fa-graduation-cap'></i></label>
          <div className='col-sm-10 input'>
            <input type="text" name="grade" id="grade" className="w-100" value={this.state.grade} onChange = {this.handleChange} />
          </div>
        </div>
